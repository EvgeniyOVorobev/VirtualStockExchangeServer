...
public class MoexService {
    ...
    RestTemplate restTemplate = new RestTemplate();
     ...
     String a = "https://iss.moex.com/iss/history/engines/stock/markets/shares/boards/TQBR/securities/";
    ...
    String de = "&iss.meta=off&iss.only=history&history.columns=SHORTNAME,SECID,WAPRICE,TRADEDATE";
